  ...
  return (
    <div className="relative flex w-full h-full flex-col">
      <div className="fixed inset-0 mx-0 max-w-none overflow-hidden">
        <div className="absolute left-1/2 top-[-14.5px] ml-[-41.5rem] h-[30rem] w-[80rem] [mask-image:linear-gradient(black,transparent)]">
          ...
          <svg viewBox="0 0 1113 440" aria-hidden="true" className="absolute left-1/2 top-0 ml-[-19rem] w-[69.5625rem] fill-[#09090B] blur-[26px]"><path d="M.016 439.5s-9.5-300 434-300S882.516 20 882.516 20V0h230.004v439.5H.016Z"></path></svg>
        </div>
      </div>
