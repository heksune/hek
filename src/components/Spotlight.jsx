                ...
                {data ? (
                    <SpotlightCard className="w-full h-fit md:col-span-3 bg-zinc-950 border-2 border-zinc-800 rounded-xl hover:bg-zinc-900 bg-gradient-to-tl backdrop-blur-xl from-transparent via-transparent to-zinc-800/80 hover:border-700 duration-500 p-3 flex items-center justify-start cursor-pointer">
                        ...
                        <div className="font-sans font-medium ml-3">
                            ...
                            <p className="text-xs text-zinc-500 line-clamp-4">{codeActivity ? codeActivity.state : "Lorem ipsum dolor sit amet consectetur."}</p>
                        </div>
                    </SpotlightCard>
                ) : (<a></a>)}

                <SpotlightCard className="w-full md:col-span-2 bg-zinc-950 border-2 border-zinc-800 rounded-xl hover:bg-zinc-900 bg-gradient-to-tr backdrop-blur-xl from-transparent via-transparent to-zinc-800/80 hover:border-700 duration-500 cursor-pointer p-4">
