...
export default function Navbar() {
    ...
    return (
        ...
        >
            <ul
                className={`relative flex space-x-4 my-4 w-fit py-2 px-5 rounded-full border border-zinc-700 shadow-md backdrop-blur-sm transition-all duration-500 ${isScrolled ? "bg-zinc-800/50" : "bg-zinc-900/20"}`}
            >
